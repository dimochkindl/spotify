...
@Service
public class TextsFileSystemStorageService implements StorageService {

    private final Path rootLocation;

    public TextsFileSystemStorageService(StorageProperties properties) {
        if(properties.getTextLocation().trim().isEmpty()) {
            throw new StorageException("Text location cannot be empty");
        }
        this.rootLocation = Paths.get(properties.getTextLocation());
    }
